...
RUN /var/lang/bin/python3.10 -m pip install torch==2.1.0+cu121 torchvision torchaudio --index-url https://download.pytorch.org/whl/cu121 huggingface-hub llama-cpp-python langchain-core tensorflow pymc
